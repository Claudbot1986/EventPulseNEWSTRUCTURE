...
|-------|-------|
| sourceId | orebro-sk |
| sourceName | Örebro SK |
| url | https://www.orebrosk.se |
| city | Örebro |
| type | idrott |
| batchId | batch-001 |
...
| patternSignals | 10tt 0d 11h=0v |

## AI Finding Summary

**What C found:** C1 identified html_candidate. Extraction returned 0 events. Triage reason: 10tt 0d 11h 0v
...
```
SOURCE_START
{"sourceId":"orebro-sk","sourceName":"Örebro SK","url":"https://www.orebrosk.se","city":"Örebro","type":"idrott","batchId":"batch-001","methodCandidate":"html_candidate","verificationStatus":"batch-eligible","eligibilityRulesVersion":"1.0","selectionCriteria":"C-htmlGate batch-eligible filter","subpageAwareAbStatus":"missing","rootChecked":true,"subpagesCheckedCount":null,"likelyEventSubpages":null,"preRunEventsFound":0,"postRunEventsFound":null,"deltaEvents":null,"preRunVerdict":"unclear","postRunVerdict":null,"preRunFailureMode":"extraction-failed","postRunFailureMode":null,"htmlPatternType":null,"patternSignals":"10tt 0d 11h=0v","aiFindingSummary":"C1: 10tt 0d 11h 0v, 0 events","generalizableLearning":null,"remainingIssue":"batch not executed","needsD":"unclear","notes":"subpageAwareAbStatus missing"}
SOURCE_END
```
