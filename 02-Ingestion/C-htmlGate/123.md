...
Efter varje batch ska fail-fallen klassificeras i exakt tre kategorier:
...
- C0-discovery-fail är ofta nätverksproblem (timeout, 404, DNS) — avgör om det är generellt mönster eller enskild sajt.
